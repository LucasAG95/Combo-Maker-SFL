...
function renderizarTabelaCropToCoins(dados) {
    ...
    let tabelaTituloCropToCoins = `
        <tr>   
            ...
            <th class="${getClasseAtiva(4)}" data-coluna="4">
                ${traducaoTabelaCropToCoins.porcentagem}<br><img src="./icones/flower.png" class="crop-img">1 ➜ <img src="./icones/coins.png" class="crop-img">320
            </th>
        </tr>`;
    ...
    dados.forEach(crop => {
        ...
        tabelaCropToCoins += `
        <tr>
            <td><img src="./crops/${crop.name}.png" class="crop-img">${crop.name}</td>
            <td><img src="./icones/coins.png" class="crop-img">${valorEmCoinsDaCrop.toFixed(2)}</td>
            <td><img src="./icones/flower.png" class="crop-img">${crop.valorDoMarket.toFixed(6)}</td>
            <td><img src="./icones/coins.png" class="crop-img">${coinsGanhasPorFlower.toFixed(2)}</td>
